...
class PDFGenerator:
    ...
    def generate_pdf(self, output_path):
        ...
        elements.append(Paragraph(
            f"Entradas Efectivo: ARS {self.format_number(data['entrada_efectivo'])}",
            ParagraphStyle(
            'SaldoStyle',
            parent=self.styles['Normal'],
            fontSize=10,
        ...
        elements.append(Paragraph(
            f"Salidas Efectivo: ARS {self.format_number(data['salida_efectivo'])}",
            ParagraphStyle(
            'SaldoStyle',
            parent=self.styles['Normal'],
            fontSize=10,
        ...
        elements.append(Paragraph(
            f"Saldo Efectivo Total: ARS {self.format_number(data['entrada_efectivo'] + data['salida_efectivo'])}",
            ParagraphStyle(
            'SaldoStyle',
            parent=self.styles['Normal'],
            fontSize=10,
        ...
        elements.append(Paragraph(
            f"Entradas Fernanda: ARS {self.format_number(data['entrada_fernanda'])}",
            ParagraphStyle(
            'SaldoStyle',
            parent=self.styles['Normal'],
            fontSize=10,
        ...
        elements.append(Paragraph(
            f"Entradas Felipe: ARS {self.format_number(data['entrada_felipe'])}",
            ParagraphStyle(
            'SaldoStyle',
            parent=self.styles['Normal'],
            fontSize=10,
